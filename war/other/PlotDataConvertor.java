 ...
 * you should make jar package which complies with Java provider registration
 ...
 *
 * The only thing left to do is to package the above dicrectories in a jar file and
 ...
 * Bear in mind that you must restart the servlet containter after dropping the 
...
public interface PlotDataConvertor {
